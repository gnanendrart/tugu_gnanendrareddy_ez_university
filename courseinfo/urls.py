...
from .views import (InstructorList, SectionList, CourseList, SemesterList, StudentList, RegistrationList,
                    InstructorDetail, SectionDetail, RegistrationDetail, SemesterDetail, CourseDetail, StudentDetail,
                    InstructorCreate, SectionCreate, RegistrationCreate, SemesterCreate, CourseCreate, StudentCreate,
